...
- A interrupção antecipada do briefing e de evento durante fanfarra foi aprovada no Windows SDL2. A vitória foi explicitamente delegada ao QA comunitário, sem aprovação funcional prévia; outras plataformas também aguardam QA interativo.
...
- A instalação/desinstalação nativa, a seleção, o briefing, eventos RC01 e o caminho `.campaign` já passaram no Windows; vitória, demais missões e outras plataformas ainda exigem prova funcional interativa.
